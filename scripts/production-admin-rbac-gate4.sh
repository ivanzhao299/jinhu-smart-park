...
assert_http_ok "organization list" "$(curl_request GET "/orgs?page=1&page_size=5")"
assert_http_ok "user list" "$(curl_request GET "/users?page=1&page_size=5")"
assert_http_ok "role list" "$(curl_request GET "/roles?page=1&page_size=20")"
assert_http_ok "role tree" "$(curl_request GET "/roles/tree")"
assert_http_ok "permission tree" "$(curl_request GET "/permissions/tree")"
assert_http_ok "data scope rules" "$(curl_request GET "/data-scopes?page=1&page_size=5")"
assert_http_ok "field policies" "$(curl_request GET "/field-policies?page=1&page_size=5")"
assert_http_ok "standard modules" "$(curl_request GET "/modules?page=1&page_size=5")"
assert_http_ok "operation audit logs" "$(curl_request GET "/audit/op-logs?page=1&page_size=5")"
