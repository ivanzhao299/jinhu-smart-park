...
const TARGETS=new Map([["人员浏览","/hr/employees"],["人员照片","/hr/employees"],["信息查询","/hr/employees"],["人事异动查询","/hr/lifecycle"],["人事异动统计","/hr/lifecycle"],["用户列表","/system/users"],["修改密码","/account/security"],["合同到期查询","/hr/contracts"],["培训记录查询","/hr/training"],["考核记录查询","/hr/performance"],["奖惩记录查询","/hr/rewards"],["保险福利","/hr/insurance"],["工资数据查询","/hr/payroll"],["考勤管理","/hr/attendance"],["招聘管理","/hr/recruitment"]]);
const GAPS=new Map();
