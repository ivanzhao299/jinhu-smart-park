...
当前全部已设计开发模块均属于目标产品范围，包括系统治理、资产、共享房产底座、民宿管理、住房出租、招商租赁、财务、工单、文件、安全、工程、IoT、能源、视频、机器人、驾驶舱、租户服务、移动终端、BIM / 数字孪生和 AI 工作编排。共享房产底座、民宿管理和住房出租 MVP 已完成开发并进入 UAT 待验收状态；其中 BIM 当前仅提供导航总览入口，完整三维模型与数字孪生能力仍待后续建设和验收。
