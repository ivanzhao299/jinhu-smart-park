...
const runId = "b2c197_prelim_20260802g";
const targets = {
  upgrade: {
  ...
  dockerExec(target, `BEGIN;
    INSERT INTO public.sys_schema_migration_history
      ...
      VALUES ('${filename}','${checksum}','succeeded',clock_timestamp(),clock_timestamp(),
        'b2c-000197-gh-loader','${runId.slice(0, 25)}-${phase}');
...
applyRecorded(targets.upgrade, chainBeforeForwardFix, "g1");
applyRecorded(targets.upgrade, forwardFixChain, "g2");

bootstrap(targets.fresh);
applyRecorded(targets.fresh, [...chainBeforeForwardFix, ...forwardFixChain], "h1");
