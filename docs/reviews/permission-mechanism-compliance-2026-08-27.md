...
6. **§15 最终收口（2026-08-28）**：首轮 `20260828-112051` 完成 G1/G4 与 8 个 Chrome 子 Case；补完轮 `20260828-122122` 及 PR #452 三轮 review 收口补齐 G2 normal/super/`*` Cartesian、G3 产品 API drift/fallback-known orphan、G5 page/action/module 双 tab/刷新/重登、G6 A/B 不同 role links/module assignments/Sidebar/page-local switch、G7 Homestay asset-off 28 endpoint、跨 tenant/park/restricted-unit、指定敏感投影、五类文件逐类全链、maker-checker CAS/幂等/并发/重试/immutable 和审批深链。第三轮以 `park:read` 暴露 static fallback 会重建 malformed seeded orphan，已最小修复为 seeded-definition authority 并以 13/13 回归关闭。G1–G7 全 PASS，无未修复产品 FAIL、无新增 Issue。父任务在 #452 CI/squash merge 与 main CI/Deploy 双绿后可归档。权威证据见 `docs/uat/pam-audit-s15-regression-uat-20260828-122122.md`。
