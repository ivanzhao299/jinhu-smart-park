...
- Task ID: `AGENT-PLATFORM-V2-A3-INVENTORY-GENERATOR`
- Batch ID: `AGENT-PLATFORM-V2-ROUND2-20260622`
- Title: Runtime inventory generator rebuild and materialization design
- Domain: orchestrator-runtime-inventory-generator
- Priority: P0
- Risk: MEDIUM
- Prompt file: `ops/agent-orchestrator/runs/AGENT-PLATFORM-V2-A3-INVENTORY-GENERATOR-agent-3.prompt.md`
...
```json
{
  "task_id": "AGENT-PLATFORM-V2-A3-INVENTORY-GENERATOR",
  ...
  "acceptance": [
    "Designs runtime-generator.mjs, runtime-rebuild.mjs, and runtime-validate.mjs responsibilities without implementing scripts in this planning task.",
    "Defines deterministic inventory rebuild behavior, duplicate detection, malformed JSON handling, and dry-run no-write requirements.",
    "Maps inventory source inputs to architecture, API, DB, module, RBAC, workflow, and risk inventories.",
    "Explains how generated runtime inventories can be validated before use by Agents or selector logic.",
...
1. Designs runtime-generator.mjs, runtime-rebuild.mjs, and runtime-validate.mjs responsibilities without implementing scripts in this planning task.
2. Defines deterministic inventory rebuild behavior, duplicate detection, malformed JSON handling, and dry-run no-write requirements.
3. Maps inventory source inputs to architecture, API, DB, module, RBAC, workflow, and risk inventories.
4. Explains how generated runtime inventories can be validated before use by Agents or selector logic.
