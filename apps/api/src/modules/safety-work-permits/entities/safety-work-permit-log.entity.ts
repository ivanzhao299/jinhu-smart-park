...
@Entity("biz_safety_work_permit_log")
@Index("idx_biz_safety_work_permit_log_scope_deleted", ["tenantId", "parkId", "isDeleted"])
@Index("idx_biz_safety_work_permit_log_permit", ["tenantId", "parkId", "workPermitId", "opTime"])
export class SafetyWorkPermitLogEntity extends AuditableEntity {
  @Column({ name: "code", type: "varchar", length: 64, nullable: true })
  code!: string | null;

  @Column({ name: "work_permit_id", type: "uuid" })
  workPermitId!: string;
