...
assert_source_contains "theme toggle has accessible label" "apps/web/components/theme/ThemeToggle.tsx" "切换主题"
assert_source_contains "attachment thumbnails have preview labels" "apps/web/components/files/AttachmentList.tsx" "预览 "
