...
assert.match(extract, /YUZHOU_MAPPING_CONTRACT_SHA256 is required/);
...
assert.match(transform, /sourceRestoreReceiptSha256/);
assert.match(transform, /mappingContractSha256/);
assert.match(transform, /source restore receipt must remain HOLD/);
