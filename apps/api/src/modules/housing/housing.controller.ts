...
export class HousingController {
  ...
  @Get("leases")
  @RequirePermissions(SYSTEM_PERMISSIONS.HOUSING_LEASE_READ)
  listLeases(
    @CurrentScope() scope: TenantParkScope,
    @CurrentUser() actor: JwtPrincipal,
  ...
  @Get("leases/:id")
  @RequireAnyPermissions(SYSTEM_PERMISSIONS.HOUSING_LEASE_READ, SYSTEM_PERMISSIONS.HOUSING_FINANCE_READ)
  getLease(
    @CurrentScope() scope: TenantParkScope,
    @CurrentUser() actor: JwtPrincipal,
    @Param("id") id: string
  ...
  @Get("purchases")
  @RequirePermissions(SYSTEM_PERMISSIONS.HOUSING_PURCHASE_READ)
  listPurchases(
    @CurrentScope() scope: TenantParkScope,
    @CurrentUser() actor: JwtPrincipal,
