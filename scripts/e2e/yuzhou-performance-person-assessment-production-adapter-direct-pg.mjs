...
try {
  ...
  psql(database, `
    ...
    CREATE FUNCTION hr_yuzhou_consume_performance_person_assessment_authorization(p_operation varchar,p_parent varchar,p_code char,p_source char,p_mapping char,p_t0 char,p_contract char,p_source_restore_receipt char,p_source_payload char,p_safe_receipt char,p_migration char,p_payload_sha char,p_sealed char,p_binding char,p_auth char,p_nonce char,p_expires timestamptz) RETURNS void LANGUAGE plpgsql AS $$
