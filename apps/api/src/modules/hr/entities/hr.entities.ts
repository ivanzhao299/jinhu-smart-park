...
export class HrPositionEntity extends AuditableEntity {
 ...
 @Column({name:"hierarchy_level",type:"smallint",nullable:true}) hierarchyLevel!:number|null;
 @Column({name:"sort_order",type:"integer",default:0}) sortOrder!:number;
 @Column({name:"legacy_source_id",type:"integer",nullable:true}) legacySourceId!:number|null;
 @Column({name:"legacy_upto_code",type:"varchar",length:30,nullable:true}) legacyUptoCode!:string|null;
 @Column({type:"varchar",length:1024,nullable:true}) authority!:string|null;
 @Column({type:"varchar",length:1024,nullable:true}) qualification!:string|null;
 @Column({type:"varchar",length:1024,nullable:true}) responsibilities!:string|null;
 @Column({name:"position_manual",type:"varchar",length:256,nullable:true}) positionManual!:string|null;
...
export class HrEmployeeProfileEntity extends AuditableEntity {
 ...
 @Column({name:"id_number_encrypted",type:"text",nullable:true}) idNumberEncrypted!:string|null;
 @Column({name:"id_number_masked",type:"varchar",length:64,nullable:true}) idNumberMasked!:string|null;
 @Column({name:"id_number_fingerprint",type:"varchar",length:96,nullable:true}) idNumberFingerprint!:string|null;
 @Column({name:"english_name",type:"varchar",length:100,nullable:true}) englishName!:string|null;
 @Column({type:"varchar",length:32,nullable:true}) gender!:string|null;
 @Column({name:"date_of_birth",type:"date",nullable:true}) dateOfBirth!:string|null;
 @Column({type:"varchar",length:64,nullable:true}) ethnicity!:string|null;
 @Column({name:"native_place",type:"varchar",length:128,nullable:true}) nativePlace!:string|null;
 @Column({name:"political_status",type:"varchar",length:64,nullable:true}) politicalStatus!:string|null;
 @Column({name:"party_join_date",type:"date",nullable:true}) partyJoinDate!:string|null;
 @Column({name:"height_cm",type:"numeric",precision:5,scale:2,nullable:true}) heightCm!:string|null;
 @Column({name:"weight_kg",type:"numeric",precision:6,scale:2,nullable:true}) weightKg!:string|null;
 @Column({name:"marital_status",type:"varchar",length:32,nullable:true}) maritalStatus!:string|null;
 @Column({name:"health_status",type:"varchar",length:64,nullable:true}) healthStatus!:string|null;
 @Column({name:"household_registration",type:"varchar",length:256,nullable:true}) householdRegistration!:string|null;
 @Column({name:"highest_education",type:"varchar",length:64,nullable:true}) highestEducation!:string|null;
 @Column({type:"varchar",length:128,nullable:true}) major!:string|null;
 @Column({type:"varchar",length:64,nullable:true}) degree!:string|null;
 @Column({name:"foreign_language",type:"varchar",length:64,nullable:true}) foreignLanguage!:string|null;
 @Column({name:"language_level",type:"varchar",length:64,nullable:true}) languageLevel!:string|null;
 @Column({name:"graduation_date",type:"date",nullable:true}) graduationDate!:string|null;
 @Column({name:"graduation_school",type:"varchar",length:160,nullable:true}) graduationSchool!:string|null;
 @Column({name:"home_phone",type:"varchar",length:32,nullable:true}) homePhone!:string|null;
 @Column({name:"job_title",type:"varchar",length:100,nullable:true}) jobTitle!:string|null;
 @Column({name:"job_grade",type:"varchar",length:64,nullable:true}) jobGrade!:string|null;
 @Column({name:"employee_category",type:"varchar",length:64,nullable:true}) employeeCategory!:string|null;
 @Column({name:"technical_title",type:"varchar",length:100,nullable:true}) technicalTitle!:string|null;
 @Column({name:"technical_grade",type:"varchar",length:64,nullable:true}) technicalGrade!:string|null;
 @Column({name:"legacy_professional_title_code",type:"varchar",length:2,nullable:true,select:false}) legacyProfessionalTitleCode!:string|null;
 @Column({name:"legacy_basic_info_id",type:"integer",nullable:true}) legacyBasicInfoId!:number|null;
...
export class HrPayrollItemVersionEntity extends AuditableEntity { @Column({name:"item_definition_id",type:"uuid"}) itemDefinitionId!:string;@Column({name:"version_no",type:"integer"}) versionNo!:number;@Column({name:"display_name",length:200}) displayName!:string;@Column({name:"value_type",length:16}) valueType!:string;@Column({name:"legacy_item_type",length:64}) legacyItemType!:string;@Column({name:"legacy_add_or_sub",length:32}) legacyAddOrSub!:string;@Column({name:"item_category",length:32}) itemCategory!:string;@Column({name:"decimal_scale",type:"integer",nullable:true}) decimalScale!:number|null;@Column({name:"sort_no",type:"integer"}) sortNo!:number;@Column({type:"boolean",nullable:true}) taxable!:boolean|null;@Column({name:"print_enabled",type:"boolean",nullable:true}) printEnabled!:boolean|null;@Column({type:"boolean"}) enabled!:boolean;@Column({name:"legacy_print_width",type:"integer",nullable:true}) legacyPrintWidth!:number|null;@Column({name:"legacy_print_width_hash",type:"varchar",length:64,nullable:true,select:false}) legacyPrintWidthHash!:string|null;@Column({name:"legacy_tax_flag",type:"varchar",length:2,nullable:true,select:false}) legacyTaxFlag!:string|null;@Column({name:"legacy_no_decimal_flag",type:"varchar",length:2,nullable:true,select:false}) legacyNoDecimalFlag!:string|null;@Column({name:"legacy_use_flag",type:"varchar",length:4,nullable:true,select:false}) legacyUseFlag!:string|null;@Column({name:"legacy_decimal_length",type:"integer",nullable:true}) legacyDecimalLength!:number|null;@Column({name:"legacy_decimal_length_hash",type:"varchar",length:64,nullable:true,select:false}) legacyDecimalLengthHash!:string|null;@Column({name:"legacy_print_report",type:"integer",nullable:true,select:false}) legacyPrintReport!:number|null;@Column({name:"legacy_print_report_hash",type:"varchar",length:64,nullable:true,select:false}) legacyPrintReportHash!:string|null;@Column({name:"legacy_item_title",type:"varchar",length:24,nullable:true}) legacyItemTitle!:string|null;@Column({name:"legacy_long_description",type:"varchar",length:100,nullable:true}) legacyLongDescription!:string|null;@Column({name:"suppress_decimals",type:"boolean",nullable:true}) suppressDecimals!:boolean|null;@Column({name:"legacy_metadata_review_required",type:"boolean"}) legacyMetadataReviewRequired!:boolean;@Column({name:"source_hash",length:64}) sourceHash!:string; }
...
export class HrContractActionEntity extends AuditableEntity { @Column({name:"contract_id",type:"uuid"}) contractId!:string;@Column({name:"change_id",type:"uuid",nullable:true}) changeId!:string|null;@Column({name:"sequence_no",type:"integer"}) sequenceNo!:number;@Column({length:32}) action!:string;@Column({name:"from_status",type:"varchar",length:32,nullable:true}) fromStatus!:string|null;@Column({name:"to_status",length:32}) toStatus!:string;@Column({type:"jsonb",default:()=>"'{}'::jsonb"}) snapshot!:Record<string,unknown>;@Column({name:"actor_user_id",type:"uuid"}) actorUserId!:string;@Column({name:"occurred_at",type:"timestamptz"}) occurredAt!:Date; }
...
@Entity("hr_insurance_policy_item") export class HrInsurancePolicyItemEntity extends AuditableEntity { @Column({name:"policy_id",type:"uuid"}) policyId!:string;@Column({name:"insurance_kind",length:32}) insuranceKind!:string;@Column({name:"variant_no",type:"integer"}) variantNo!:number;@Column({name:"base_rate",type:"numeric",precision:18,scale:6,nullable:true}) baseRate!:string|null;@Column({name:"employer_rate",type:"numeric",precision:18,scale:6,nullable:true}) employerRate!:string|null;@Column({name:"employee_rate",type:"numeric",precision:18,scale:6,nullable:true}) employeeRate!:string|null;@Column({name:"supplement_rate",type:"numeric",precision:18,scale:6,nullable:true}) supplementRate!:string|null;@Column({name:"base_fixed_amount",type:"numeric",precision:18,scale:3,nullable:true}) baseFixedAmount!:string|null;@Column({name:"employer_fixed_amount",type:"numeric",precision:18,scale:3,nullable:true}) employerFixedAmount!:string|null;@Column({name:"employee_fixed_amount",type:"numeric",precision:18,scale:3,nullable:true}) employeeFixedAmount!:string|null;@Column({name:"supplement_fixed_amount",type:"numeric",precision:18,scale:3,nullable:true}) supplementFixedAmount!:string|null; }
