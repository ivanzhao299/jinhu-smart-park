...
assert.equal(inventory.permissions.expectedAuthorizationGrantEdges, 915);
assert.equal(inventory.permissions.importerContract.policy, "no_user_bound_rows_in_public_inventory_no_functionality_credit");
