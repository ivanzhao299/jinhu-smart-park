...
| 民宿管理 | 日价、房态、预订、入住、退房、人工收退款、保洁 | MVP 开发完成，菜单为“民宿管理 → 民宿运营 → `/homestay`” | `uat_pending` | 未启用 | [专项验证证据](./homestay-mvp-evidence.md)：最终候选 `8012b854` 的单测/类型/构建与 Chrome DevTools MCP 多视口 UAT 已通过；PostgreSQL 16 民宿专用真实 API E2E 已覆盖并发、改期、no-show、退款/减免、跨园区、多角色、文件与 residual=0；main `619b8d20` 的 CI、Release Smoke、生产健康/清理和公开生产保护账号校验已通过。仅待业务真人具名签署，继续保持 `uat_pending/awaiting_human_gate` |
