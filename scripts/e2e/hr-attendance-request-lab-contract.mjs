...
test("attendance request lab runner keeps a five-hour capacity, isolated gate and cleanup contract",()=>{
 for(const value of ["MIN_DURATION_MINUTES=300","stopAfter:\"rollback_ready\"","run-hr-attendance-request-pg-gate.sh","POSTGRES_HOST:\"127.0.0.1\"","HR_ATTENDANCE_LAB_CLEANUP_INVALID","residualCount!==0","productionImport:\"HOLD\""])assert.match(script,new RegExp(value.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")));
