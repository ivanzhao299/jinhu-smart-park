...
for(const value of ["isolated_rehearsal","^jinhu_hr_migration_lab_","YUZHOU_T0_RUN_ID","compatible succeeded T0 batch required","ownerSourceIdentitySha256","PHOTO_OWNER_UNMAPPED","PHOTO_OWNER_AMBIGUOUS","T5_FILE_SOURCE_ACCOUNTING","T5_FILE_NO_BINARY_OR_LINK_WRITE","T5_LEGACY_HISTORY","hr_legacy_t5_file_evidence","source_identity_sha256=","hr_employee_compensation","hr_payslip"])assert.match(load,new RegExp(value.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")));
