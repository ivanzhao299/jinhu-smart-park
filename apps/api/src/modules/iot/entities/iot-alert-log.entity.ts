...
@Entity("biz_iot_alert_log")
@Index("idx_biz_iot_alert_log_entity_scope_deleted", ["tenantId", "parkId", "isDeleted"])
@Index("idx_biz_iot_alert_log_entity_alert", ["tenantId", "parkId", "alertId", "isDeleted"])
export class IotAlertLogEntity extends AuditableEntity {
