...
export function validateYuzhouLiveRoleUatP0Matrix(matrix){
  ...
  for(const check of matrix.checks){
    if(JSON.stringify(Object.keys(check).sort())!==JSON.stringify(["actor","assertions","id","method","outcome","responseKind","route"].sort()))fail("YUZHOU_UAT_P0_MATRIX_SHAPE_INVALID",check.id);
