...
decision_result="$(node "$ROOT_DIR/scripts/hr-cutover/verify-yuzhou-t1-event-type-decision.mjs" "$TYPE_DECISION_FILE")" || fail "employment event type decision contract is invalid"
