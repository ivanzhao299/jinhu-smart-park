...
assert.match(script, /WHEN '1' THEN 'active' WHEN '6' THEN 'probation' WHEN 'A' THEN 'active'/);
assert.match(script, /WHEN '5' THEN 'suspended' WHEN 'B' THEN 'suspended' ELSE 'departed'/);
