...
const TARGETS=new Map([["人员浏览","/hr/employees"],["信息查询","/hr/employees"],["人事异动查询","/hr/lifecycle"],["用户列表","/system/users"],["合同到期查询","/hr/contracts"],["培训记录查询","/hr/training"],["考核记录查询","/hr/performance"],["奖惩记录查询","/hr/rewards"],["保险福利","/hr/insurance"],["工资数据查询","/hr/payroll"],["考勤管理","/hr/attendance"],["招聘管理","/hr/recruitment"]]);
const GAPS=new Map([["人员照片","TARGET_DEDICATED_PHOTO_VIEW_NOT_IMPLEMENTED"],["人事异动统计","TARGET_EMPLOYMENT_CHANGE_STATISTICS_NOT_IMPLEMENTED"],["修改密码","TARGET_SELF_SERVICE_PASSWORD_CHANGE_NOT_IMPLEMENTED"]]);
