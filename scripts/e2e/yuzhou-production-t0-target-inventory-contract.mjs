...
const input = {
  ...
  targetScope: scope,
  records: [
    { targetTable: "sys_org", targetId: "11111111-1111-4111-8111-111111111111", targetVersion: 1, targetFields: { org_code: "ROOT", org_name: "Fixture Org", org_type: "company", sort_order: 0, status: "enabled", remark: null, contact_phone: null, planned_headcount: null, legacy_source_id: null }, derivedFields: { parent_id: null } },
    { targetTable: "hr_position", targetId: "22222222-2222-4222-8222-222222222222", targetVersion: 2, targetFields: { position_code: "P1", position_name: "Fixture Position", job_family: null, job_level: null, headcount_limit: null, status: "enabled", remark: null, authority: null, legacy_source_id: null, legacy_upto_code: null, position_manual: null, qualification: null, responsibilities: null, legacy_parent_reference: null, legacy_department_reference: null }, derivedFields: { org_id: "11111111-1111-4111-8111-111111111111" } },
