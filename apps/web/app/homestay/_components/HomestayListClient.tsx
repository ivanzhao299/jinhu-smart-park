...
function createHomestayReturnContext(surface: HomestayListSurface, filters: HomestayListFilters): HomestayListReturnContext {
  return {
    route: surface,
    query: {
...
function homestayPaginatedData(
  surface: HomestayListSurface,
...
function hasActiveHomestayFilters(filters: HomestayListFilters): boolean {
  return [
