WITH permission_rows(code, name, resource, action, api_method, api_path, frontend_route, sort_no) AS (
  VALUES
    ('leasing_contract:archive', '合同签章归档', 'biz.leasing_contract', 'archive', 'POST', '/api/v1/leasing/contracts/:id/archive', '/leasing/contracts', 327),
    ('leasing_contract:file_read', '合同附件读取', 'biz.leasing_contract', 'file_read', 'GET', '/api/v1/leasing/contracts/:id/files', '/leasing/contracts', 328)
)
