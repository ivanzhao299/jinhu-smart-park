...
-- Extend the already-authorized T5 non-file slice with the normalized,
-- row-oriented projection of dbo.person.def* and dbo.defs. Files and payroll
...
ALTER TABLE hr_yuzhou_production_import_record
  ...
  ADD CONSTRAINT ck_hr_yuzhou_prod_record_target_allowlist CHECK (
    ...
    OR (phase='T5' AND target_table IN ('hr_employee_profile','hr_employee_family','hr_employee_skill','hr_employee_credential','hr_custom_field_definition','hr_employee_custom_value'))
  ),
  ...
  ADD CONSTRAINT ck_hr_yuzhou_prod_record_planned_target_allowlist CHECK (
    ...
    OR (phase='T5' AND planned_target_table IN ('hr_employee_profile','hr_employee_family','hr_employee_skill','hr_employee_credential','hr_custom_field_definition','hr_employee_custom_value'))
  );
