...
const migration = readFileSync(
  resolve(__dirname, "../../../../../database/migrations/000212_code_rule_scope_provisioning.sql"),
  "utf8"
);

test("000212 backfills only live scopes and persisted provisionable modules", () => {
