...
export async function loadHousingTenants(input: RemoteEntityLoadInput): Promise<RemoteEntityPage> {
...
export async function loadHousingUnits(input: RemoteEntityLoadInput): Promise<RemoteEntityPage> {
...
export async function loadHousingLeases(input: RemoteEntityLoadInput): Promise<RemoteEntityPage> {
