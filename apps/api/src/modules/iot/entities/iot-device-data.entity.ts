...
@Entity("biz_iot_device_data")
@Index("idx_biz_iot_device_data_entity_scope_deleted", ["tenantId", "parkId", "isDeleted"])
@Index("idx_biz_iot_device_data_entity_metric_time", ["tenantId", "parkId", "deviceId", "metricCode", "reportedAt"])
export class IotDeviceDataEntity extends AuditableEntity {
