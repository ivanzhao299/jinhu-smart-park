...
| 民宿管理 | 日价、房态、预订、入住、退房、人工收退款、保洁 | MVP 开发完成，待 UAT | `uat_pending` | 未启用 | [专项验证证据](./homestay-mvp-evidence.md)：迁移、类型检查、单元测试、隔离库业务回归和本地桌面/390px 视觉验收已通过；待民宿专用真实 API E2E 及目标 UAT 权限、文件和业务数据验收 |
