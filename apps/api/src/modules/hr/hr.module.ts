...
@Module({imports:[TypeOrmModule.forFeature([...HR_ENTITIES,OrgEntity,UserEntity,UserMessageEntity]),AuditModule],controllers:[HrController,HrGoalReportController,HrPerformanceReviewController,HrFeedback360Controller,HrTalentController,HrPayrollHistoryController,HrRecruitmentController,HrOnboardingController,HrProbationController,HrJobChangeController,HrLifecycleController,HrTrainingController,HrRewardsController],providers:[HrService,HrGoalReportService,HrPerformanceReviewService,HrPerformanceEvaluationService,HrFeedback360Service,HrTalentService,HrNotificationService,HrPayrollHistoryService,HrRecruitmentService,HrOnboardingService,HrProbationService,HrJobChangeService,HrLifecycleService,HrTrainingService,HrRewardsService,PartySensitiveDataService],exports:[HrService,HrGoalReportService,HrPerformanceReviewService,HrPerformanceEvaluationService,HrFeedback360Service,HrTalentService,HrPayrollHistoryService,HrRecruitmentService,HrOnboardingService,HrProbationService,HrJobChangeService,HrLifecycleService,HrTrainingService,HrRewardsService]})
