...
const EVIDENCE = [
  ...
  ["FIELD_PERFORMANCE_GRADE", "scripts/hr-cutover/contracts/legacy-performance-assgradecode-field-map-v1.json"],
  ...
  ["PAGE_GROUP_WEB_PERFORMANCE_TEMPLATE_EVALUATION", "scripts/hr-cutover/contracts/group-web-performance-template-evaluation-modern-runtime-task-v1.json"],
  ["PAGE_GROUP_WEB_PERFORMANCE_REPORT_CENTER", "scripts/hr-cutover/contracts/group-web-performance-report-center-modern-runtime-task-v1.json"],
  ["PAGE_GROUP_WEB_PERFORMANCE_DEPARTMENT_TASK", "scripts/hr-cutover/contracts/group-web-performance-department-task-modern-runtime-task-v1.json"],
...
const GROUP_WEB_TASK_IDS = [
  ...
  "PAGE_GROUP_WEB_PERFORMANCE_TEMPLATE_EVALUATION",
  "PAGE_GROUP_WEB_PERFORMANCE_REPORT_CENTER",
  "PAGE_GROUP_WEB_PERFORMANCE_DEPARTMENT_TASK",
];
const BODY_KEYS = [
  "formatVersion",
  "artifactKind",
...
function progressInputs(parsed) {
  return {
    ...
    performanceMappings: [
      parsed.get("FIELD_PERFORMANCE_ASSESSMENT"),
      parsed.get("FIELD_PERFORMANCE_GRADE"),
      parsed.get("FIELD_PERFORMANCE_ITEM"),
