-- Backfill dictionary baselines into existing tenant/park scopes.
-- Runtime tenant and additional-park provisioning now performs the same copy for new scopes.
