...
WITH b AS(SELECT id FROM migration_batch WHERE run_id=:'run'),v(domain,source_object,n,h,status) AS(VALUES
 ...
 ('employee_profile_raw','dbo.person',2949,'fd5f0a2891b93b65a4d8489f0428ae861ed666f879d5e532d99a8215e1c9e0d2','running'),
 ('employee_profile_raw','dbo.person_user',0,'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855','skipped'),
 ('employee_profile_raw','dbo.person_user_item',8,'0d47ff522c88dc619c4fcd07ca6777648f7b051c77e09f2d9b37677814d45287','running'),
 ('employment_change_raw','dbo.readjust',6887,'46a761c975b3b52d7445bef749b479d24e93e10a62274583e2a9b8c0253616f1','running'),
 ('employment_change_raw','dbo.readjustitem',8,'36b1f2ad92a81c7c2ff821f1333cb6425ad76567fbcacc68dec071abee7ea585','running'),
 ('employment_change_raw','dbo.jobstatecode',8,'a50f28e5bc4f8e5c74675ad6f333778cd664e66698e1ca8de074169ec8b30605','running'),
 ('contract_raw','dbo.compact',802,'45b60db3baedc33f1808783ced6def768c00bc0a7d6eb8127066742db65079de','running'),
 ('contract_raw','dbo.compact_c',357,'2c34dcf52562ea5cfbad91f0d5d6bfe43a738f571b97184017e9d2470daab7dc','running'),
 ('contract_raw','dbo.compacttypecode',4,'a140b43b7f1b69de8b6a23ea1389fd2d26cee66f88b8de93300556d8e4f1db63','running'),
...
FROM source_rows s LEFT JOIN LATERAL(
 SELECT min(x.id::text)::uuid id,count(*) matches FROM hr_employee x
