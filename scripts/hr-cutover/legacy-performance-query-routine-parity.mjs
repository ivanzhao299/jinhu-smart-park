...
const EXPECTED = [
  ...
  },
  {
    ...
    outputCount: 8,
    semanticContractSha256: "1250a2df2004b56ea62171aaceaabed8748cb943783246cbab788bd7aa1554bc",
    modernStatus: "implemented_pending_runtime_uat",
    modernService: "HrPerformanceLegacyService.assessmentValueOfPersonQuery",
    modernApi: "GET /hr/performance-legacy/query-reports/assessment-value-of-person",
    modernPage: "apps/web/app/hr/performance/HrPerformanceLegacyAssessmentValueOfPersonPanel.tsx",
    dynamic: true,
    missingColumns: ["assessmentmaster.asssession", "assessmentmaster.grade"],
  },
  {
  ...
  },
  {
    ...
    outputCount: 6,
    semanticContractSha256: "4258b117626f060374fe5ab1ea7e7a48a7a7145f5f68f55263774faee7339225",
    modernStatus: "implemented_pending_runtime_uat",
    modernService: "HrPerformanceLegacyService.webAssQuery",
    modernApi: "GET /hr/performance-legacy/query-reports/web-ass-query",
    modernPage: "apps/web/app/hr/performance/HrPerformanceLegacyWebAssQueryPanel.tsx",
    dynamic: true,
