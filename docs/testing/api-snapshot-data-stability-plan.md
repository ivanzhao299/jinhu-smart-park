...
后续同步：固定样本 baseline 已解决 detail / logs 锚点稳定性；`workorders.list / workorders.stats` 仍受写入型 e2e 影响。list / stats 快照波动治理设计见 `docs/testing/api-snapshot-list-stats-stability-plan.md`。
