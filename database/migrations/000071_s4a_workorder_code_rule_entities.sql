...
code_rules(entity_type, rule_code, rule_name, target_module, target_entity, prefix, pattern, date_pattern, sequence_length, reset_policy, separator, example_code, remark) AS (
  VALUES
    ('workorder_log', 'WORKORDER_LOG_CODE', '工单日志编码规则', 'workorder', 'workorder_log', 'WOL-', '{PREFIX}{DATE:yyyyMM}-{SEQ:6}', 'yyyyMM', 6, 'monthly', '', 'WOL-202605-000001', 'S4-A workorder log code rule')
)
