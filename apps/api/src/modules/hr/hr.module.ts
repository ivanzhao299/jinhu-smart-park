...
@Module({imports:[TypeOrmModule.forFeature([...HR_ENTITIES,OrgEntity,UserEntity,UserMessageEntity]),AuditModule],controllers:[HrController,HrGoalReportController,HrPerformanceReviewController,HrFeedback360Controller,HrTalentController,HrPayrollHistoryController,HrRecruitmentController,HrOnboardingController,HrProbationController,HrLifecycleController,HrTrainingController,HrRewardsController],providers:[HrService,HrGoalReportService,HrPerformanceReviewService,HrPerformanceEvaluationService,HrFeedback360Service,HrTalentService,HrNotificationService,HrPayrollHistoryService,HrRecruitmentService,HrOnboardingService,HrProbationService,HrLifecycleService,HrTrainingService,HrRewardsService,PartySensitiveDataService],exports:[HrService,HrGoalReportService,HrPerformanceReviewService,HrPerformanceEvaluationService,HrFeedback360Service,HrTalentService,HrPayrollHistoryService,HrRecruitmentService,HrOnboardingService,HrProbationService,HrLifecycleService,HrTrainingService,HrRewardsService]})
