...
const [migration,seed,controller,service,menu,shared,layout,workbench]=await Promise.all([
 read("database/migrations/000202_apartment_management_foundation.sql"),read("database/seeds/production/000011_apartment_management_rbac.sql"),read("apps/api/src/modules/apartments/apartments.controller.ts"),read("apps/api/src/modules/apartments/apartments.service.ts"),read("apps/web/lib/menu.ts"),read("packages/shared/src/apartment.ts"),read("apps/web/app/apartments/layout.tsx"),read("apps/web/app/apartments/ApartmentWorkbench.tsx")
]);
