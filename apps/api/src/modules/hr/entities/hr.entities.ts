...
export class HrPositionEntity extends AuditableEntity {
 ...
 @Column({name:"job_family",length:64,nullable:true}) jobFamily!:string|null;
 @Column({name:"job_level",length:32,nullable:true}) jobLevel!:string|null;
...
export class HrEmployeeEntity extends AuditableEntity {
 ...
 @Column({name:"work_location",length:128,nullable:true}) workLocation!:string|null;
 @Column({name:"work_mobile",length:32,nullable:true}) workMobile!:string|null;
 @Column({name:"work_email",length:128,nullable:true}) workEmail!:string|null;
}
...
export class HrEmployeeProfileEntity extends AuditableEntity {
 ...
 @Column({name:"id_type",length:32,nullable:true}) idType!:string|null;
 @Column({name:"id_number_masked",length:64,nullable:true}) idNumberMasked!:string|null;
 @Column({name:"personal_mobile",length:32,nullable:true}) personalMobile!:string|null;
 @Column({name:"personal_email",length:128,nullable:true}) personalEmail!:string|null;
 @Column({length:500,nullable:true}) address!:string|null;
 @Column({name:"emergency_contact_name",length:100,nullable:true}) emergencyContactName!:string|null;
 @Column({name:"emergency_contact_mobile",length:32,nullable:true}) emergencyContactMobile!:string|null;
}
...
export class HrEmploymentEventEntity extends AuditableEntity {
 ...
 @Column({length:500,nullable:true}) reason!:string|null;
...
export class HrGoalEntity extends AuditableEntity {
 ...
 @Column({type:"numeric",precision:7,scale:4,default:1}) weight!:string; @Column({name:"metric_name",length:100,nullable:true}) metricName!:string|null;
 ...
 @Column({length:32,nullable:true}) unit!:string|null; @Column({type:"numeric",precision:7,scale:4,default:0}) progress!:string;
...
export class HrGoalCheckinEntity extends AuditableEntity {
 ...
 @Column({length:2000}) summary!:string; @Column({length:2000,nullable:true}) risks!:string|null;
...
export class HrWorkReportEntity extends AuditableEntity {
 ...
 @Column({name:"reviewer_employee_id",type:"uuid",nullable:true}) reviewerEmployeeId!:string|null; @Column({name:"review_comment",length:1000,nullable:true}) reviewComment!:string|null;
...
export class HrPerformancePlanEntity extends AuditableEntity {
 ...
 @Column({name:"final_score",type:"numeric",precision:7,scale:2,nullable:true}) finalScore!:string|null; @Column({name:"self_summary",length:4000,nullable:true}) selfSummary!:string|null;
 @Column({name:"manager_comment",length:4000,nullable:true}) managerComment!:string|null; @Column({name:"calibration_comment",length:4000,nullable:true}) calibrationComment!:string|null;
...
export class HrFeedbackResponseEntity extends AuditableEntity {
 ...
 @Column({length:3000,nullable:true}) strengths!:string|null; @Column({length:3000,nullable:true}) improvements!:string|null; @Column({name:"submitted_at",type:"timestamptz"}) submittedAt!:Date;
}
