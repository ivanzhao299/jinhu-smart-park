    ...
    <main className="content">
      <header className="header">
        <div className="header-title">
          ...
          <span>Engineering Project Delivery Runtime · Phase 1 Project / Planning / Daily Report / Inspection / Rectification 已接入</span>
        </div>
      ...
      <Card>
        <div className="empty-state">
          ...
          <span>工程项目中心、工程计划管理、施工日报、工程巡检和整改闭环已接入真实 API。后续任务继续进入逾期检测和验收。</span>
        </div>
      </Card>
