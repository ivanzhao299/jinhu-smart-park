...
const decisionsContent = {
  ...
  records: [
    decision("T0", "sys_org", "1", { org_code: "000", org_name: "集团", org_type: "company", sort_order: 0, status: "enabled", remark: "legacy", contact_phone: null, planned_headcount: null, legacy_source_id: null }),
    decision("T0", "hr_position", "2", { position_code: "P01", position_name: "职员", job_family: null, job_level: null, headcount_limit: null, status: "enabled", remark: null, authority: null, legacy_source_id: null, legacy_upto_code: null, position_manual: null, qualification: null, responsibilities: null, sort_order: 0 }, [dep("org", "T0", "1", "sys_org")]),
