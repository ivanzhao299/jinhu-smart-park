...
- Trellis key-rotation contract synchronized with the final review fixes: strict versioned-read failure, active-key-bound replay, and HR historical-key retirement prohibition.
