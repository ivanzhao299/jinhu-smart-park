...
@Module({imports:[TypeOrmModule.forFeature([...HR_ENTITIES,OrgEntity,UserEntity,UserMessageEntity]),AuditModule],controllers:[HrController,HrGoalReportController,HrPayrollHistoryController,HrRecruitmentController,HrLifecycleController,HrTrainingController,HrRewardsController],providers:[HrService,HrGoalReportService,HrNotificationService,HrPayrollHistoryService,HrRecruitmentService,HrLifecycleService,HrTrainingService,HrRewardsService,PartySensitiveDataService],exports:[HrService,HrGoalReportService,HrPayrollHistoryService,HrRecruitmentService,HrLifecycleService,HrTrainingService,HrRewardsService]})
