...
function payloadFor(table, suffix, sourceIdentitySha256, protectedFileId) {
  ...
  const values = {
    ...
    hr_position: { position_code: `POS-${suffix}`, position_name: `Lab Position ${suffix}`, job_family: null, job_level: "L1", headcount_limit: 2, hierarchy_level: 3, sort_order: -2, status: "enabled", remark: null, authority: "权限说明", legacy_source_id: 102, legacy_upto_code: "ROOT", position_manual: "  ", qualification: null, responsibilities: "岗位职责", legacy_parent_reference: "ROOT-PARENT", legacy_department_reference: "ROOT-DEPT" },
