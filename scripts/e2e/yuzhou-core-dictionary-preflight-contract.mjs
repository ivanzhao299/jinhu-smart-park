...
const base=code=>({formatVersion:1,artifactKind:"yuzhou_hr_dictionary_machine_decision",sourceSystem:"yuzhou-v10",sourceSnapshotSha256:t1.sourceSnapshotSha256,sourceCaptureSha256:"a".repeat(64),dictionaryCode:code,sourceObject:`fixture.${code}`,sourceRecordCount:1,decisions:[{sourceValue:"fixture",usageCount:1,decision:"map",targetDomain:code,targetValue:"fixture_target",reasonCode:"FIXTURE_MACHINE_REVIEWED"}],productionImport:"HOLD"});
